  ...
  <>
    ...
    <article id={styles.about}>
      ...
      <p>
        ...
        fra norsk media og har som formål å finne ut av hva som skiller kvinner
        og menn skriftlig.
      </p>
      <p>
        ...
        skrevet trusselbrevene som er omtalt. Dette på grunn av at ordet "tisse"
        ble brukt fremfor ordet "pisse". Du kan lese mer om saken{" "}
      ...
      <p>
        ...
        Man skal dermed ikke ta denne så seriøst. Dette er bare et prosjekt
        laget for morrohetens skyld og er ikke ment for bruk til forskning eller
        andre seriøse formål.
      </p>
      <p>
        Takk til{" "}
